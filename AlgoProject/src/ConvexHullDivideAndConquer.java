...
public class ConvexHullDivideAndConquer extends JPanel {
    ...
    public ConvexHullDivideAndConquer() {
        ...
        getActionMap().put("calculateConvexHull", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(points.size() <=5){
                    System.out.println("Time complexity is o(n^3) as 5 or less then 5 points");}
                else{
                    System.out.println("Time Complexity is O(nLogn) as more then 5 points " );
    ...
    private void calculateConvexHull() {
        ...
        points.sort(new PolarAngleComparator(pivot));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Convex Hull Divide and Conquer");
            ConvexHullDivideAndConquer convexHullDivideAndConquer = new ConvexHullDivideAndConquer();
            frame.add(convexHullDivideAndConquer);
            frame.pack();
